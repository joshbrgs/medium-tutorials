...
class RspackDevServer extends webpack_dev_server_1.default {
    ...
    addAdditionalEntries(compiler) {
        ...
        if (this.options.client && isWebTarget) {
            ...
            additionalEntries.push(`${require.resolve("@rspack/dev-server/client/index.js")}?${webSocketURLStr}`);
        }
        if (this.options.hot === "only") {
            additionalEntries.push(require.resolve("@rspack/core/hot/only-dev-server.js"));
        }
