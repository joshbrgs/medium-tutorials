    ...
    compilation: {
        ...
        chunks: (object, compilation, context, options, factory) => {
            ...
            const chunks = context
                .getInner(compilation)
                .getChunks(options.chunkModules, options.chunkRelations, options.reasons, options.moduleAssets, options.nestedModules, options.source);
        ...
        modules: (object, compilation, context, options, factory) => {
            ...
            const array = context
                .getInner(compilation)
                .getModules(options.reasons, options.moduleAssets, options.nestedModules, options.source);
